...
MACRO_CONFIG_INT(DbgDummiesWeapon, dbg_weapon, 0, 0, 6, CFGFLAG_SERVER, "Set weapon the debug dummies should hold (1=hammer, 2=pistol, 3=shotgun, 4=grenade, 5=laser, 6=ninja)")
